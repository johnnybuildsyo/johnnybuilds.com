const Intro = () => {
  return (
    <p className="max-w-2xl mx-auto px-8 text-center mt-4" style={{ textWrap: "balance" }}>
      ...
      <a className="border-b border-dashed border-foreground/40 hover:border-foreground/50 px-0.5" href="https://x.com/johnnybuildz">
        X
      </a>
      ,{" "}
