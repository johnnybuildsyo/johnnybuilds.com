const Footer = () => {
  return (
    <footer className="w-full flex flex-col sm:flex-row justify-center gap-2 sm:gap-8 text-center text-base pt-8 pb-12 border-t bg-background relateive z-10">
